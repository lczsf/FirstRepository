...
public class WaveOrderDO {
	 ...
	 * 波次说明类型
	 */
	private Integer waveDescriptionType;
	...
	public Integer getWaveDescriptionType() {
		return waveDescriptionType;
	}

	public void setWaveDescriptionType(Integer waveDescriptionType) {
		this.waveDescriptionType = waveDescriptionType;
	}
